...
from LIBERO.libero.libero.envs.bddl_base_domain import BDDLBaseDomain, register_problem
from LIBERO.libero.libero.envs.robots import *
from LIBERO.libero.libero.envs.objects import *
from LIBERO.libero.libero.envs.predicates import *
from LIBERO.libero.libero.envs.regions import *
from LIBERO.libero.libero.envs.utils import rectangle2xyrange
...
class Libero_Tabletop_Manipulation(BDDLBaseDomain):
    ...
    def _setup_camera(self, mujoco_arena):
        # CAM-01: recalibrated for the real AR0144 overhead camera. The
        # initial datasheet-derived guess (fovy 43, a lower/closer pose) was
        # superseded once the physical mount was installed: human-tuned via
        # an interactive live-render comparison against an actual photo from
        # the connected camera (same tuning approach as eye_in_hand, plan
        # 07-01 checkpoint), across multiple stages of a real recorded demo.
